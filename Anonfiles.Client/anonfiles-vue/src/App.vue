<template>
  <div
    class="w-full justify-center items-center flex p-4 overflow-auto flex-col"
  >
        ...
        <tr v-for="(item, index) in inputFiles" :key="index">
          ...
          >
            <button
              ...
              class="px-4 py-1 text-md text-red-600 font-semibold rounded-sm border border-red-600 hover:text-white hover:bg-red-600 hover:border-transparent focus:outline-none focus:ring-2 focus:ring-red-400 focus:ring-offset-2"
            >
              Delete
            </button>
          </td>
